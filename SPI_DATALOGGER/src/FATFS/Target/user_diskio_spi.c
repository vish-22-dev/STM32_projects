...
uint8_t SD_Test_CMD8(void)
{
    return send_cmd(CMD8, 0x1AA);
}

uint8_t SD_Test_ACMD41(void)
{
    return send_cmd(ACMD41, 1UL << 30);
}

uint8_t SD_Test_CMD58(void)
{
	return send_cmd(CMD58, 0);
}
